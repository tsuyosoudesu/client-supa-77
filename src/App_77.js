...
import StaticCrown_77 from './pages/local/CorwnStaticPage_77';
const App_77 = () => {
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path='/supaMenu_77/:category'
          element={<MenuByCategoryPage_77 />}
        />
        <Route path='/node_menu_77' element={<MenuNodePage_77 />} />
        <Route path='/StaticCrown_77' element={<StaticCrown_77 />} />
